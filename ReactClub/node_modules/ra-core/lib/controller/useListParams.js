...
var useListParams = function (_a) {
    ...
    var hideFilter = react_1.useCallback(function (filterName) {
        ...
        var newDisplayedFilters = removeKey_1.default(displayedFilterValues, filterName);
        setFilters(newFilters, newDisplayedFilters);
    }, requestSignature); // eslint-disable-line react-hooks/exhaustive-deps
    var showFilter = react_1.useCallback(function (filterName, defaultValue) {
        setFilters(set_1.default(filterValues, filterName, defaultValue), set_1.default(displayedFilterValues, filterName, true));
    }, requestSignature); // eslint-disable-line react-hooks/exhaustive-deps
    return [
